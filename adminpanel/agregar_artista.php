            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">AGREGAR NUEVO ARTISTA</h4>
                            </div>
                            <div class="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="txtapellido" class="form-control" placeholder="Escriba los apellidos del artista" value="" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  name="txtnacionalidad" class="form-control" placeholder="Escriba la nacionalidad del artista" value="" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date"  name="txtfecha" class="form-control" placeholder="Country" value="" required>
                                            </div>
                                        </div>
