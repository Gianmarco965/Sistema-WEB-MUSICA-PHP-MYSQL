...
<body>
    ...
    <header>
        <div class="w3-bar w3-light-grey">
          ...
          <a href="artistas.php" class="w3-bar-item w3-red w3-button w3-mobile">Artistas</a>
          <a href="contacto.php" class="w3-bar-item w3-button w3-mobile">Contacto</a>
